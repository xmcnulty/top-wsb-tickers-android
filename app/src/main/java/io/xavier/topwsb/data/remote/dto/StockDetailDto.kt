...
/**
 * Converts a [StockDetailDto] to [StockDetail] with required information for application use.
 *
 * @return [StockDetail] from data contained in this Dto object
 */
fun StockDetailDto.toStockDetail(): StockDetail = StockDetail(
    ticker = Symbol,
    companyName = Name,
